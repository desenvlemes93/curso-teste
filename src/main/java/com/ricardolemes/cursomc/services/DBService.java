...
import com.ricardolemes.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cliente1 = new Cliente(null, "Joao Da silva", "binh@gmail.com", "12345", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		
		Cliente cliente2 = new Cliente(null, "Eu da SIlva Sauro", "teste@gmail.com", "45698",TipoCliente.PESSOAJURIDICA, pe.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, pedi2, sdf.parse("20/10/2017 12:12"),
				null);
